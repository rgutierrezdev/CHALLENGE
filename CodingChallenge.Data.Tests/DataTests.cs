...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        {
            Assert.AreEqual("<h1>¡Lista vacía de formas!</h1>",Reporte.Imprimir(new List<Figura>(),String.Empty));
        }
        [TestCase]
        public void TestResumenListaVaciaEnIngles()
        {            
            Assert.AreEqual("<h1>¡Empty list of shapes!</h1>", Reporte.Imprimir(new List<Figura>(),"ingles"));
        }
        [TestCase]
        public void TestResumenListaVaciaEnFrances()
        {            
            Assert.AreEqual("<h1>¡Liste vide de formes!</h1>", Reporte.Imprimir(new List<Figura>(),"frances"));
        }
        #endregion
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var resumen = Reporte.Imprimir(figuras,String.Empty);
        ...
        {
            var figuras = new List<Figura> { new FiguraCuadrado(5) };
            var resumen = Reporte.Imprimir(figuras,"ingles");
        ...
        {
            var figuras = new List<Figura> { new FiguraCuadrado(5) };
            var resumen = Reporte.Imprimir(figuras,"frances");
